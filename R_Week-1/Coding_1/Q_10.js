...
let fil = movies.filter(num=>num.genre =='Sci-Fi')
.filter(ele=>ele.rating>=8)
let total = fil.reduce((acc,cur)=>acc+cur.rating,0)

let t = fil.map(ele=>ele.title)
console.log(t)
console.log(total/fil.length)